...
```
Если выводит вот такое сообщение, но интернет не работает, это значит, что у вас неправильный ip-адрес. Первым делом надо выставить на роутере правильное [время](/setup/wersonit_new.md). Поскольку чаще всего эта проблема возникает, если вы попытались авторизоваться в сети МИЭТа, а время на роутере значительно отстает от реального. После этого нужно убедиться, что ip-адрес на WAN-интерфейсе не совпадает с тем, который указан в личном кабинете OnPlus. Для этого нужно в ЛК перейти на вкладку услуги, там будет ip-адрес. А ip-адрес WAN-интерфейса роутера можно узнать на вкладке сеть -> интерфейсы. Если они не совпадают, вам необходимо написать в поддержку о том, что у вас не открывается ничего, кроме ориокса. Через некоторое время вам ответят и подключение к интернету будет работать. <br><br><br>
...
3. Ваш аккаунт в ориоксе уже привязан к другому MAC-адресу. В этом случае можно поменять MAC-адрес роутера на тот MAC-адрес, к которому привязан ваш аккаунт, либо оформить интернет на другого человека, либо же подождать несколько дней, пока привязка пропадет.<br><br><br>
