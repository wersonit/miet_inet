...
~Роутеры D-Link из [этого](setup/d-link.md#список-подходящих-моделей) списка тоже не требуют прошивки!~ <br>Нет поддержки EAP-PEAP/MSCHAPv2. Есть только EAP-TTLS/MSCHAPv2.<br>Нужно проверить, работает ли авторизацию.<br><br>
